...
if(arob_mpc_CONFIG_INCLUDED)
  return()
endif()
set(arob_mpc_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(arob_mpc_SOURCE_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/project/catkin_ws/src/arob_mpc)
  set(arob_mpc_DEVEL_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/project/catkin_ws/devel/.private/arob_mpc)
  set(arob_mpc_INSTALL_PREFIX "")
  set(arob_mpc_PREFIX ${arob_mpc_DEVEL_PREFIX})
else()
  set(arob_mpc_SOURCE_PREFIX "")
  set(arob_mpc_DEVEL_PREFIX "")
  set(arob_mpc_INSTALL_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/project/catkin_ws/install)
  set(arob_mpc_PREFIX ${arob_mpc_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'arob_mpc' is deprecated")
...
if(NOT "/home/albertozafra7/Desktop/Universidad/Master/AR/project/catkin_ws/devel/.private/arob_mpc/include " STREQUAL " ")
  set(arob_mpc_INCLUDE_DIRS "")
  set(_include_dirs "/home/albertozafra7/Desktop/Universidad/Master/AR/project/catkin_ws/devel/.private/arob_mpc/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Alberto <876628@unizar.es>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${arob_mpc_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'arob_mpc' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'arob_mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/albertozafra7/Desktop/Universidad/Master/AR/project/catkin_ws/src/arob_mpc/${idir}'.  ${_report}")
    endif()
    _list_append_unique(arob_mpc_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND arob_mpc_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND arob_mpc_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT arob_mpc_NUM_DUMMY_TARGETS)
      set(arob_mpc_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::arob_mpc::wrapped-linker-option${arob_mpc_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR arob_mpc_NUM_DUMMY_TARGETS "${arob_mpc_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::arob_mpc::wrapped-linker-option${arob_mpc_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND arob_mpc_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(arob_mpc_LIBRARY_DIRS ${lib_path})
      list(APPEND arob_mpc_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'arob_mpc'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND arob_mpc_LIBRARIES ${lib})
    endif()
  endif()
...
set(arob_mpc_EXPORTED_TARGETS "arob_mpc_generate_messages_cpp;arob_mpc_generate_messages_eus;arob_mpc_generate_messages_lisp;arob_mpc_generate_messages_nodejs;arob_mpc_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${arob_mpc_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 arob_mpc_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${arob_mpc_dep}_FOUND)
      find_package(${arob_mpc_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${arob_mpc_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(arob_mpc_INCLUDE_DIRS ${${arob_mpc_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(arob_mpc_LIBRARIES ${arob_mpc_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${arob_mpc_dep}_LIBRARIES})
  _list_append_deduplicate(arob_mpc_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(arob_mpc_LIBRARIES ${arob_mpc_LIBRARIES})

  _list_append_unique(arob_mpc_LIBRARY_DIRS ${${arob_mpc_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(arob_mpc_EXPORTED_TARGETS ${${arob_mpc_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "arob_mpc-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${arob_mpc_DIR}/${extra})
  endif()
  include(${extra})
endforeach()

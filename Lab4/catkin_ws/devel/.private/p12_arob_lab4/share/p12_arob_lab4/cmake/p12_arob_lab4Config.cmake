...
if(p12_arob_lab4_CONFIG_INCLUDED)
  return()
endif()
set(p12_arob_lab4_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(p12_arob_lab4_SOURCE_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/Lab4/catkin_ws/src/p12_arob_lab4)
  set(p12_arob_lab4_DEVEL_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/Lab4/catkin_ws/devel/.private/p12_arob_lab4)
  set(p12_arob_lab4_INSTALL_PREFIX "")
  set(p12_arob_lab4_PREFIX ${p12_arob_lab4_DEVEL_PREFIX})
else()
  set(p12_arob_lab4_SOURCE_PREFIX "")
  set(p12_arob_lab4_DEVEL_PREFIX "")
  set(p12_arob_lab4_INSTALL_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/Lab4/catkin_ws/install)
  set(p12_arob_lab4_PREFIX ${p12_arob_lab4_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'p12_arob_lab4' is deprecated")
...
set(p12_arob_lab4_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(p12_arob_lab4_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${p12_arob_lab4_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'p12_arob_lab4' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'p12_arob_lab4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/albertozafra7/Desktop/Universidad/Master/AR/Lab4/catkin_ws/src/p12_arob_lab4/${idir}'.  ${_report}")
    endif()
    _list_append_unique(p12_arob_lab4_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND p12_arob_lab4_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND p12_arob_lab4_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT p12_arob_lab4_NUM_DUMMY_TARGETS)
      set(p12_arob_lab4_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::p12_arob_lab4::wrapped-linker-option${p12_arob_lab4_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR p12_arob_lab4_NUM_DUMMY_TARGETS "${p12_arob_lab4_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::p12_arob_lab4::wrapped-linker-option${p12_arob_lab4_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND p12_arob_lab4_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(p12_arob_lab4_LIBRARY_DIRS ${lib_path})
      list(APPEND p12_arob_lab4_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'p12_arob_lab4'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND p12_arob_lab4_LIBRARIES ${lib})
    endif()
  endif()
...
set(p12_arob_lab4_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${p12_arob_lab4_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 p12_arob_lab4_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${p12_arob_lab4_dep}_FOUND)
      find_package(${p12_arob_lab4_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${p12_arob_lab4_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(p12_arob_lab4_INCLUDE_DIRS ${${p12_arob_lab4_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(p12_arob_lab4_LIBRARIES ${p12_arob_lab4_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${p12_arob_lab4_dep}_LIBRARIES})
  _list_append_deduplicate(p12_arob_lab4_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(p12_arob_lab4_LIBRARIES ${p12_arob_lab4_LIBRARIES})

  _list_append_unique(p12_arob_lab4_LIBRARY_DIRS ${${p12_arob_lab4_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(p12_arob_lab4_EXPORTED_TARGETS ${${p12_arob_lab4_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${p12_arob_lab4_DIR}/${extra})
  endif()
  include(${extra})
endforeach()

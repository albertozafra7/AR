...
if(pXX_arob_lab2_CONFIG_INCLUDED)
  return()
endif()
set(pXX_arob_lab2_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(pXX_arob_lab2_SOURCE_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/Lab2/catkin_ws/src/p12_arob_lab2)
  set(pXX_arob_lab2_DEVEL_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/Lab2/catkin_ws/devel/.private/pXX_arob_lab2)
  set(pXX_arob_lab2_INSTALL_PREFIX "")
  set(pXX_arob_lab2_PREFIX ${pXX_arob_lab2_DEVEL_PREFIX})
else()
  set(pXX_arob_lab2_SOURCE_PREFIX "")
  set(pXX_arob_lab2_DEVEL_PREFIX "")
  set(pXX_arob_lab2_INSTALL_PREFIX /home/albertozafra7/Desktop/Universidad/Master/AR/Lab2/catkin_ws/install)
  set(pXX_arob_lab2_PREFIX ${pXX_arob_lab2_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'pXX_arob_lab2' is deprecated")
...
set(pXX_arob_lab2_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/albertozafra7/Desktop/Universidad/Master/AR/Lab2/catkin_ws/src/p12_arob_lab2/include " STREQUAL " ")
  set(pXX_arob_lab2_INCLUDE_DIRS "")
  set(_include_dirs "/home/albertozafra7/Desktop/Universidad/Master/AR/Lab2/catkin_ws/src/p12_arob_lab2/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${pXX_arob_lab2_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pXX_arob_lab2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pXX_arob_lab2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/albertozafra7/Desktop/Universidad/Master/AR/Lab2/catkin_ws/src/p12_arob_lab2/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pXX_arob_lab2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "pXX_arob_lab2")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND pXX_arob_lab2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND pXX_arob_lab2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT pXX_arob_lab2_NUM_DUMMY_TARGETS)
      set(pXX_arob_lab2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pXX_arob_lab2::wrapped-linker-option${pXX_arob_lab2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pXX_arob_lab2_NUM_DUMMY_TARGETS "${pXX_arob_lab2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pXX_arob_lab2::wrapped-linker-option${pXX_arob_lab2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pXX_arob_lab2_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(pXX_arob_lab2_LIBRARY_DIRS ${lib_path})
      list(APPEND pXX_arob_lab2_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'pXX_arob_lab2'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND pXX_arob_lab2_LIBRARIES ${lib})
    endif()
  endif()
...
set(pXX_arob_lab2_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${pXX_arob_lab2_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 pXX_arob_lab2_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${pXX_arob_lab2_dep}_FOUND)
      find_package(${pXX_arob_lab2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pXX_arob_lab2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(pXX_arob_lab2_INCLUDE_DIRS ${${pXX_arob_lab2_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(pXX_arob_lab2_LIBRARIES ${pXX_arob_lab2_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${pXX_arob_lab2_dep}_LIBRARIES})
  _list_append_deduplicate(pXX_arob_lab2_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(pXX_arob_lab2_LIBRARIES ${pXX_arob_lab2_LIBRARIES})

  _list_append_unique(pXX_arob_lab2_LIBRARY_DIRS ${${pXX_arob_lab2_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(pXX_arob_lab2_EXPORTED_TARGETS ${${pXX_arob_lab2_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${pXX_arob_lab2_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
